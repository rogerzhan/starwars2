...
#define MAX_LEG_EXCL 60 //maximum number of demand legs from which a single aircraft (not a fleet) or pilot is excluded
...
#define MAX_AC_TYPES 7 //6 //5 - CX - 12/04/2009 ANG  //maximum number of aircraft types - CJ4 - 12/23/11 ANG
...
#define ArcAllocChunk 500 //6/14/2017 //100 //used for dynamic memory allocation of network (duty-to-duty) arcs
...
#define MAX_CRPR_PER_AC 3 //AD2017 5 //maximum crew pairs per aircraft in existing schedule - 04/23/08 ANG
#define SMALL_INCENTIVE 2 //Mainly used for output purpose if model is indifferent to pick either option. - 05/16/08 RLZ
//CONTIGENCY CONSTS
...
#define MIN_CRPR_DUTYMINS 150 //the minimum time a valid crew pair should have
#define PURE_CREW_AC_FLAG 0
#define TRAVEL_REQ_FLAG 0  //Temporarily disable the travel request codes
#define MAX_NUM_DEM_COPY 100 //max number of inclusion copies //fei Jan 2011