char *svnKeyWords[] = {
"$LastChangedDate: 2008-09-25 11:09:35 -0400 (Thu, 25 Sep 2008) $",
"$Revision: 12415 $",
"$LastChangedBy: adaniel $",
"$HeadURL: http://csintranetdev01/repos/trunk/optimizer/cmdWin/CSHOpt_mainDir/CSHOpt_main.c $",
"$Id: CSHOpt_main.c 12415 2008-09-25 15:09:35Z adaniel $",
...
main(int argc, char **argv)
{
	...
	while(--argc) 
	{
		...
		else if(strncasecmp("--msgkey=", arg, 9) == 0) 
			setCmdLineVar("msgkey", arg + 9);
...
//	/////////////////////////////////////////////// MOVED BELOW - END - 02/19/08 ANG
	...
	/////////////////////////////////////////////////////////
	// get message key needed to send message back to parent
	/////////////////////////////////////////////////////////
	if((paramVal = getCmdLineVar("msgkey")))
		strcpy(msgkey,paramVal);	
...
//END SO CHANGE
		...
		//RLZ SEND MSG BEFORE WRITINT TO OAG
		
		if (*msgkey) sendParentMessage(msgkey, "0");
		
		if (withOag==0 && *msgkey ) sleep(3);
