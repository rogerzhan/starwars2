char *svnKeyWords[] = {
"$LastChangedDate: 2008-07-08 12:56:11 -0400 (Tue, 08 Jul 2008) $",
"$Revision$",
"$LastChangedBy: lzhan $",
"$HeadURL: http://csintranetdev01/repos/trunk/optimizer/cmdWin/CSHOpt_mainDir/CSHOpt_main.c $",
"$Id: CSHOpt_main.c 10556 2008-07-08 16:56:11Z lzhan $",
...
main(int argc, char **argv)
{
	...
	while(--argc) 
	{
		...
		if(strncasecmp("--windowStart=", arg, 14) == 0) 
			...
			setCmdLineVar("uncovFlyHomePenalty2", arg + 23); // 04/22/08 ANG
...
getParameters(char *params)
{
   ...
   /////////////////////////////////
	...
	for(x = 0; x < vc; ++x) {
		dt = dt_addToDateTime(Hours, travelcutoff, dt_run_time_GMT); //need to get travelcutoff into parameters file
